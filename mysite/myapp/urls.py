...
urlpatterns = [
    ...
    path('SpecialBooks/', views.doctors, name='doctors'),
    path('doctor_search/', views.doctor_search, name='doctor_search'),
    path('create_booking/<int:doctor_id>/', views.create_appointment, name='create_appointment'),
    path('cancel_booking/<int:appointment_id>/<int:doctor_id>/', views.cancel_appointment, name='cancel_appointment'),
